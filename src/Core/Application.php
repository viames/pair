...
class Application {
	...
	private function __construct() {
		...
		set_exception_handler('\Pair\Support\Utilities::customExceptionHandler');
	 ...
	 */
	public function toast(string $message, string $title='', ?string $type=NULL): IziToast {
	...
	/**
	 * Proxy function to append a toast notification to queue.
	 *
	 * @param	string	Toast’s error message.
	 * @param	string	Title, optional.
	 */
	public function toastError(string $message, string $title=''): IziToast {
