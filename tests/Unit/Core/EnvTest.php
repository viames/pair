...
class EnvTest extends TestCase {
	...
	public function testLoadFallsBackToDefaultsWhenEnvFileIsMissing(): void {
		...
		$this->assertSame('', Env::get('GEMINI_API_KEY'));
		$this->assertSame('https://generativelanguage.googleapis.com/v1beta', Env::get('GEMINI_API_BASE_URL'));
		$this->assertSame('gemini-2.5-flash', Env::get('GEMINI_GENERATION_MODEL'));
		$this->assertSame('gemini-embedding-2', Env::get('GEMINI_EMBEDDINGS_MODEL'));
		$this->assertSame(30, Env::get('GEMINI_TIMEOUT'));
		$this->assertSame(5, Env::get('GEMINI_CONNECT_TIMEOUT'));
		$this->assertSame('', Env::get('CLAUDE_API_KEY'));
		$this->assertSame('https://api.anthropic.com/v1', Env::get('CLAUDE_API_BASE_URL'));
		$this->assertSame('claude-sonnet-4-5', Env::get('CLAUDE_MESSAGES_MODEL'));
		$this->assertSame('2023-06-01', Env::get('CLAUDE_API_VERSION'));
		$this->assertSame(1024, Env::get('CLAUDE_MAX_TOKENS'));
		$this->assertSame(30, Env::get('CLAUDE_TIMEOUT'));
		$this->assertSame(5, Env::get('CLAUDE_CONNECT_TIMEOUT'));
