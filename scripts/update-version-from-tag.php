...
if (!file_exists($envFile)) {
	print "Error: File .env not found in " . $envFile . PHP_EOL;
	exit(1);
}

// fetch all tags first to ensure we have the latest ones
...
if (empty($gitTag)) {
	print "Error: Unable to get the Git tag. Check that the repository has at least one tag." . PHP_EOL;
	exit(1);
}
