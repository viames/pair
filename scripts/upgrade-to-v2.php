...
foreach ($files as $file) {
	...
	if (0 === strpos($file->getPathname(), APP_ROOT . '/templates/')) {
		...
		$content = str_replace('$this->pageContent', '$app->pageContent', $content);
		$content = str_replace('$this->pageTitle', '$app->pageTitle', $content);
		$content = str_replace('$this->log', '$app->logBar', $content);
